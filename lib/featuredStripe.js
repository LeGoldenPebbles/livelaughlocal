...
export async function chargeFeatured(articleDoc) {
  ...
  try {
    paymentIntent = await stripe.paymentIntents.create({
      ...
      off_session: true,
      confirm: true,
      // Stripe emails its own receipt for the charge alongside our
      // confirmation email (needs "Successful payments" enabled in the Stripe
      // dashboard email settings).
      receipt_email: articleDoc.submitterEmail || undefined,
      description:
